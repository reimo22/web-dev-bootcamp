...
import bodyParser from "body-parser"; // body parser not used since we are not taking inputs from user
...
app.post("/submit", (req, res) => {
  ...
  var randomNoun = noun[Math.floor(Math.random() * noun.length) + 1];
